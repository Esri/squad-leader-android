...
2. Get the latest military symbology files:
  ...
  3. Coppy mil2525c.dat from Esri/military-features-data/data/mil2525c to the source/SquadLeader/assets/2525cSymDictionary directory in your Squad Leader clone.
