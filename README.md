...
2. Get the latest military symbology files:
  1. Go to https://github.com/Esri/military-features-data/tree/master/data/mil2525c/messagetypes and download all the .json files to your clone's source/SquadLeader/assets/2525cSymDictionary/MessageTypes directory.
  2. Go to https://github.com/Esri/military-features-data/tree/master/data/mil2525c/dictionary and download mil2525c.dat to your clone's source/SquadLeader/assets/2525cSymDictionary directory.
